...
class stonesTestCase(unittest.TestCase):
    ...
    def test_circumference(self):
        ...
        check, _1, _2 = get_circumference(x1, y1, sqrt(2))
        ...
        check, _1, _2 = get_circumference(x2, y2, sqrt(2))
        ...
        check, _1, _2 = get_circumference(x3, y3, sqrt(2))
        ...
        check, _1, _2 = get_circumference(x4, y4, 1)
